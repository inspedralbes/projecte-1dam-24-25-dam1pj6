...
const Motorcycle = require('../models/incidencia'); // Asegúrate de tener el modelo Motorcycle importado

// Llistar categories
router.get('/', async (req, res) => {
  try {
    // Obtener todas las categorías y sus motos asociadas
    const categories = await Category.findAll({
      include: Motorcycle, // Incluir las motos asociadas a cada categoría
    });

    // Pasar tanto las categorías como las motos a la vista
